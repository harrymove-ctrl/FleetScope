      ...
      <div className="relative min-h-0 flex-1">
        ...
        >
          <div className="mx-auto flex max-w-3xl flex-col gap-6">
            <p className="text-center text-xs text-neutral-500 dark:text-neutral-500">Today</p>
            ...
            <div className="flex justify-end">
              <p className="max-w-[85%] rounded-[var(--rb-r-2xl,14px)] bg-neutral-100 px-3.5 py-2.5 text-sm text-neutral-900 dark:bg-neutral-800 dark:text-neutral-100">
                Clean up the archived projects: we&rsquo;re over the storage quota again.
              </p>
            </div>

            <p className="text-sm leading-relaxed text-neutral-900 dark:text-neutral-100">
              Twelve archived projects haven&rsquo;t been opened in over a year. Removing them and
              their build history frees about 4.2 GB. Because this is permanent, I need you to
              ...
              >
                <div className="rounded-[var(--rb-r-lg,10px)] border border-neutral-200/70 bg-white px-3 py-3 dark:border-neutral-800 dark:bg-neutral-950 sm:px-4">
                  ...
                  <p className="mt-1.5 text-[13px] leading-relaxed text-neutral-600 dark:text-neutral-400">
                    Frees 4.2 GB in the storage-cleanup workspace. Active projects are untouched and
                    ...
                    <div className="ml-auto flex items-center gap-1">
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          setAnnouncement('Approved. Deleted 12 projects and freed 4.2 GB.');
                        }}
                        className={cx(
            ...
            {decision === 'approved' && (
              ...
              >
                Done: your archive is cleaned up. I&rsquo;ll flag projects for review the next time
                you pass 90% of the quota.
              </motion.p>
            )}
          </div>
        </div>
